<template>
    <ul class="ml-1 mt-8 flex items-center">
        ...
        <li class="mr-5 text-xs">
        <a class="block hover:text-slate-200" href="https://www.instagram.com/melinaniavarani?igsh=MWQzN3V0Nnk1Y2xibw%3D%3D&utm_source=qr" target="_blank" rel="noreferrer">
